package com.arjkre.SuperMarioClone.Screens;
...
import com.arjkre.SuperMarioClone.Sprites.Items.Item;
...
import com.arjkre.SuperMarioClone.Tools.B2WorldCreator;
import com.arjkre.SuperMarioClone.Tools.WorldContactListener;
...
public class PlayScreen implements Screen {
    ...
    public PlayScreen(Main game) {
        ...
        gamePort = new FillViewport(Main.V_WIDTH / Main.PPM, Main.V_HEIGHT / Main.PPM, gamecam);
    ...
    public void update(float dt) {
        ...
        float maxX = mapWidth - gamePort.getWorldWidth() / 2;

        if (player.currentState != Mario.State.DEAD) {
            gamecam.position.x = Math.max(minX, Math.min(maxX, player.b2body.getPosition().x));
        }
