package com.arjkre.SuperMarioClone.Tools;
...
import com.arjkre.SuperMarioClone.Sprites.Enemies.Enemy;
import com.arjkre.SuperMarioClone.Sprites.Enemies.Turtle;
import com.arjkre.SuperMarioClone.Sprites.TileObjects.Brick;
import com.arjkre.SuperMarioClone.Sprites.TileObjects.Coin;
import com.arjkre.SuperMarioClone.Sprites.Enemies.Goomba;
...
public class B2WorldCreator {
    ...
    public B2WorldCreator(PlayScreen screen) {
        ...
        bdef.position.set(0, mapHeight / 2 / Main.PPM);
        body = world.createBody(bdef);
        shape.setAsBox(0.1f, mapHeight / 2 / Main.PPM);
        fdef.shape = shape;
        body.createFixture(fdef);

        bdef.position.set(mapWidth / Main.PPM, mapHeight / 2 / Main.PPM);
        body = world.createBody(bdef);
        shape.setAsBox(0.1f, mapHeight / 2 / Main.PPM);
        fdef.shape = shape;
        body.createFixture(fdef);
